...
if(isset($_POST['email'])) {
    ...
    $email_to = "chalescostadosol@outlook.com";
...
$headers = 'From: [CONTATO] Site Chalés <'.$email_from.">\r\n".
'Reply-To: '.$email_from."\r\n" .
'X-Mailer: PHP/' . phpversion();
mail($email_to, $email_subject, $email_message, $headers);  
 
echo "<script>alert('Obrigado! Em breve entraremos em contato. Thank you! We will contact you soon.');window.location.assign('http://chalescostadosol.com.br/');</script>";
